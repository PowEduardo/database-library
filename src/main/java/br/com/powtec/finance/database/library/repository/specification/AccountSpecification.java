...
@NoArgsConstructor
@Component
public class AccountSpecification implements BaseCrudSpecification<AccountModel> {

  public Specification<AccountModel> getQuery(String parameters) {
    return new Specification<>() {

      @SuppressWarnings("null")
      @Override
      @Nullable
      public Predicate toPredicate(Root<AccountModel> root, CriteriaQuery<?> query,
